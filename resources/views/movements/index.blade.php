...
<div class="relative flex justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="relative  items-top justify-center bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        <div class=" grid justify-items-end bg-gray-100 dark:bg-gray-900 sm:items-center mt-4 py-4 sm:pt-0">
            <a href="{{ route('movements.create') }}" class="btn btn-primary">Crear Movimiento</a>
        </div>
        <table >
            <thead>
            <tr>
